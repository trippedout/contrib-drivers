...
/**
 * SensorDriver implementation of the {@link Adcv2x ADC V20 Module}
 */

public class Adcv2xSensorDriver implements AutoCloseable {
    private static final String TAG = Adcv2xSensorDriver.class.getSimpleName();
    ...
    static UserSensor build(final Adcv2x adc) {
